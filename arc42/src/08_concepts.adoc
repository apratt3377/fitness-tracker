...
Domain Models & SChemas
    Workout domain (relational)
    user domain (relational)
    notification domain (document)
    auth domain (redis)


Also include: resiliency with error handling, fault tolerance with DLQ, scalability with stateless services, security with jwt, authorization pattern with rbac, sensitive data like passwords, async processing, api design, logging, monitoring, persistence strategy, configurability, testability, build management
